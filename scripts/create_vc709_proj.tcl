...
set root_dir [pwd]
set proj_dir $root_dir/build/proj_vc709
...
#This is used in rx_isolation, maybe we use this later again
...
# We could add it by .xcic
#add_files -norecurse /home/dasidler/workspace/fpga-network-stack/ip/cmd_fifo_xgemac_rxif.xcix
...
#or we could add it by .xci
#add_files -norecurse /home/dasidler/workspace/fpga-network-stack/ip/cmd_fifo_xgemac_rxif/cmd_fifo_xgemac_rxif.xci
#export_ip_user_files -of_objects  [get_files  /home/dasidler/workspace/fpga-network-stack/ip/cmd_fifo_xgemac_rxif/cmd_fifo_xgemac_rxif.xci] -force -quiet
#update_compile_order -fileset sources_1
